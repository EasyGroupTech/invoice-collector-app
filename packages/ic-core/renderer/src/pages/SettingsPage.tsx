...
/** §6's Profile management, §6's config Import/Export, §14.1's Invoice history retention/clear,
 * Sources/Destinations management, §6's Sessions UI, §9's Plugins management, §13's "Third-Party
 * Licenses"/SBOM screen, and §7's Advanced Settings — sections of one page rather than separate
 ...
 * Profiles, Import/Export, then Invoice history first, matching the reference app's own section
 * order exactly; Sources/Destinations next, then Sessions/Plugins — all things a user is more
 * likely to actually need to act on — Advanced Settings/SBOM last, since both are closer to "set
 * once" than "check regularly." */
