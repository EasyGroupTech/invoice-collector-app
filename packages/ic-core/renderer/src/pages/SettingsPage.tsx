 ...
 * Sources/Destinations management, §9's Plugins management (§13's "Third-Party Licenses"/SBOM
 * screen combined into that same card — see `PluginsSection`'s own doc comment), and §7's Advanced
 * Settings (§14.1's Invoice history retention/clear folded into that same card too — see
 * `AdvancedSettingsSection`'s own doc comment) — sections of one page rather than separate
 ...
 * belong next to each other), then Logs; Sources/Destinations next, then Plugins — things a user is
